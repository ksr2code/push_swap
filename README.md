...
* Implemented several helper functions for data parsing.
* Participated in algorithm testing, analysis, and validation.
* Contributed to design discussions and project structure.

### Kaisar Smailov (ksmailov)
* Implemented O(n√n), O(n log n), and adaptive sorting algorithms.
* Developed core stack operations and instruction logic.
* Integrated benchmarking and performance metrics.
* Worked with Matvii on debugging, testing, and optimization.